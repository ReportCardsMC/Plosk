...
public class PlotTeleportEvent extends BukkitPlotEvent implements Cancellable {
    private final PlayerTeleportToPlotEvent event;

    public PlotTeleportEvent(PlayerTeleportToPlotEvent event) {
        this.event = event;
    }
